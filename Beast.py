...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7342443926:AAELHjDdLEphOnOnZDHVLRMUuee2JSO_0so'  # Replace with your bot token
OWNER_USERNAME = "AashuZodYt"  # Replace with your Telegram username (without @)
DEFAULT_GROUP_ID = -1002502237427  # Default group ID
...
async def start(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        message = (
            ...
            "* 𝐓𝐇𝐈𝐒 𝐁𝐎𝐓 𝐌𝐀𝐃𝐄 𝐁𝐘 @BEASTXOFFICIAL *"
        )
...
async def handle_button_click(update: Update, context: CallbackContext):
    ...
    if chat.type == "private" and not is_authorized_user(update):
        await update.message.reply_text("❌ *𝐓𝐡𝐢𝐬 𝐛𝐨𝐭 𝐢𝐬 𝐧𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐭𝐨 𝐮𝐬𝐞 𝐡𝐚𝐫𝐞 DM @BEASTxOFFICIAL.*", parse_mode='Markdown')
        return
